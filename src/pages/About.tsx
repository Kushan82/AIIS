      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 md:pl-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">About Atharva Insurance & Investment Solution</h2>
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8">
          <Stat 
            icon={<Clock size={28} color='#111827'/>}
            number="20+"
            label="Years Experience"
          />
          <Stat 
            icon={<Users size={28} color='#111827' />}
            number="1,500+"
            label="Clients Served"
          />
          <Stat 
            icon={<Award size={28} color='#111827' />}
            number="High"
            label="Client Satisfaction"
          />
          <Stat 
            icon={<UserCheck size={28} color='#111827'/>}
            number="10Cr"
