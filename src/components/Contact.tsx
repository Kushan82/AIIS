            ...
            <form ref={form} onSubmit={sendEmail} className="space-y-4" encType="multipart/form-data">
              <div>
                ...
                <input
                  ...
                  id="name"
                  required
                  className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#cddde6]"
              ...
              <div>
                <label htmlFor="previous_policy" className="block text-gray-700 mb-1">Attach Previous Policy (optional)</label>
                <input
                  type="file"
              ...
              <div>
                <span className="block text-gray-700 mb-1">Claims made in previous policy?</span>
                <div className="flex gap-6">
                  <label className="flex items-center space-x-2">
                    <input type="radio" name="claims_made" value="Yes" className="accent-[#cddde6]" required />
                    <span>Yes</span>
                  </label>
                  <label className="flex items-center space-x-2">
                    <input type="radio" name="claims_made" value="No" className="accent-[#cddde6]" />
                    <span>No</span>
                  </label>
                </div>
              </div>
